...
def set_default_commands():
    # ... (код функции set_default_commands остается прежним) ...
...
# --- 7. Запуск бота (ДЛИТЕЛЬНЫЙ ПУЛИНГ) ---

if __name__ == '__main__':
    init_db()
    set_default_commands()

    # !!! Важно: Отключаем вебхук перед пулингом !!!
    bot.remove_webhook()
    time.sleep(1)

    print("Бот запускается в режиме длительного пулинга...")
